	...
	while (keepAlive) {
		...
		try {
			if (command.compare("mode") == 0) {
				...
				this->uiSetMylistLocation(inputString);
			}
			else if (command.compare("openMylist") == 0) {
				this->uiOpenMylist(inputString);
			}
...
void Console::uiSelectMode(string inputString) {
	...
	if (position == string::npos) { throw RecordingException("Invalid arguments for 'mode' command."); }
...
void Console::uiAddRecording(string inputString) {
	int position = inputString.find(" ");
	if (position == string::npos) { throw RecordingException("Invalid arguments for 'add' command."); }
	inputString.erase(0, position + 1);
...
void Console::uiUpdateRecording(string inputString) {
	int position = inputString.find(" ");
	if (position == string::npos) { throw RecordingException("Invalid arguments for 'update' command."); }
	inputString.erase(0, position + 1);
...
void Console::uiDeleteRecording(string inputString) {
	int position = inputString.find(" ");
	if (position == string::npos) { throw RecordingException("Invalid arguments for 'delete' command."); }
	inputString.erase(0, position + 1);
...
void Console::uiListRecordings(string inputString) {
	...
	if (position == string::npos) {
		...
		position = inputString.find(", ");
		if (position == string::npos) { throw RecordingException("Invalid arguments for 'list' command."); }
		string currentToken = inputString.substr(0, position);
		string location = currentToken;
		inputString.erase(0, position + 2);
...
void Console::uiNextRecording(string inputString) {
	int position = inputString.find(" ");
	if (position != string::npos) { throw RecordingException("Invalid arguments for 'next' command."); }
...
void Console::uiSaveRecording(string inputString) {
	int position = inputString.find(" ");
	if (position == string::npos) { throw RecordingException("Invalid arguments for 'save' command."); }
	inputString.erase(0, position + 1);
...
void Console::uiSeeWatchlist(string inputString) {
	int position = inputString.find(" ");
	if (position != string::npos) { throw RecordingException("Invalid arguments for 'mylist' command."); }
...
void Console::uiSetFileLocation(string inputString) {
	int position = inputString.find(" ");
	if (position == string::npos) { throw RecordingException("Invalid arguments for 'fileLocation' command."); }
	inputString.erase(0, position + 1);
...
void Console::uiSetMylistLocation(string inputString) {
	int position = inputString.find(" ");
	if (position == string::npos) { throw RecordingException("Invalid arguments for 'mylistLocation' command."); }
	inputString.erase(0, position + 1);

	string currentToken = inputString.substr(0, inputString.size());
	string mylistLocation = currentToken;

	position = inputString.find("\n");
	if (position != string::npos) { throw RecordingException("Invalid arguments for 'mylistLocation' command."); }

	this->recordingController->setMylistLocation(mylistLocation);
}

void Console::uiOpenMylist(string inputString) {
	int position = inputString.find(" ");
	if (position != string::npos) { throw RecordingException("Invalid arguments for 'open' command."); }

	this->recordingController->openMylist();
}
